# Generated by Django 2.2.14 on 2020-07-19 20:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_times', models.ManyToManyField(related_name='hours_ranges', to='stores.OpenTime')),
            ],
        ),
        migrations.CreateModel(
            name='CartStock',
        ...
        migrations.AddField(
            model_name='cart',
            name='voucher',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='carts', to='stores.Voucher'),
        ),
    ]
